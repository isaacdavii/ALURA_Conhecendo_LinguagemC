...
// 6- usamos o SWITCH() para escolher o nível de dificuldade (linha 45)
// 7- adicionamos uma tela de apresentação para o jogo
...
int main()
{
    ...
    switch(nivel){
        case 1:
            ...
            break; // se não colocarmos 'break' para o programa
                   // ele vai executar todos os 'cases' abaixo
        case 2:
